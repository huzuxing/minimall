                            ...
                            if (row.parent_id == "0") {
                                ...
                                if (childNodes.length > 0) {
                                    ...
                                    $.each(childNodes, function (i) {
                                        ...
                                        var subchildNodes = $.learunindex.jsonWhere(data, function (v) { return v.parent_id == subrow.id });
                                        _html += '<li>';
                                        if (subchildNodes.length > 0) {
                                            _html += '<a href="#"><i class="' + subrow.icon + '"></i>' + subrow.zh_name + '';
                                            _html += '<i class="fa fa-angle-left pull-right"></i></a>';
                                            _html += '<ul class="treeview-menu">';
                                            $.each(subchildNodes, function (i) {
                                                var subchildNodesrow = subchildNodes[i];
                                                _html += '<li><a class="menuItem" data-id="' + subrow.id + '" href="' + subrow.url + '"><i class="' + subchildNodesrow.icon + '"></i>' + subchildNodesrow.zh_name + '</a></li>';
                                            });
                                            _html += '</ul>';

                                        } else {
                                            _html += '<a class="menuItem" data-id="' + subrow.id + '" href="' + subrow.url + '" target="' + subrow.target + '"><i class="' + subrow.icon + '"></i>' + subrow.zh_name + '</a>';
                                        }
                                        _html += '</li>';
                                    });
                                    _html += '</ul>';
